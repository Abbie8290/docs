...
description: "Retrieves weather and water conditions and an overall recommendation related to surfing"
---
## Endpoints
**surfreport/{beachId}**
...
```curl cURL
curl -I -X GET "https://api.openweathermap.org/com/surfreport/123?appid=APIKEY"
```

```javascript JavaScript - jQuery
var settings = {
  "url": "https://api.openweathermap.org/com/surfreport/123?appid=APIKEY",
  "method": "GET",
  "timeout": 0,
};
...
```http HTTP
GET /com/surfreport/123?appid=APIKEY HTTP/1.1
...
url = URI("https://api.openweathermap.org/com/surfreport/123?appid=APIKEY")
