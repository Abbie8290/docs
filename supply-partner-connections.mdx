...
* _Not Connected_ : The partner does not have an active Supply Connect account. <br/> <Info> Your organization can create pseudo-company partnerships with no intentions of becoming connected as a way to maintain records within Supply Connect.</Info>
...
3. Enter the **Email or Company name** associated with the partner your company wants to connect with. Select **Search**. <br/>
<Frame>
<img src="/images/NewPartner_EmailSearch.png" />
</Frame><br/>
All companies matching the email or company name appear in the **Company** drop-down for selection.
4. Select the correct company record and select the **Continue** button. <br/>
<Note>If the company you want to partner with is not in Supply Connect, select the **Add New partner** option in the **Company** drop-down to send the company an invitation to join Supply Connect.</Note>
...
The company is immediately available on the _Manage Partner Connections_ screes in a _Connected_ status to edit or further configure additional sharing rules.
  </Tab>
