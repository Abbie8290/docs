...
Ticket tags are configured per supplier company, and ticket values for all applicable objects are stored in the system when a ticket record is shared. Buyer companies can then assign a tag value to the appropriate ticket value.
